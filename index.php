            ...
            <div class="width-9 combined">
                <div class="width-9 holder top">
                    ...
                    <div class="width-3 portrude mediumComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($photoBlockS2->author_id)->first_name . " " . Author::findById($photoBlockS2->author_id)->last_name ?></p>
                    ...
                    <div class="width-6 portrude longComponent ver1">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($photoBlockS3->author_id)->first_name . " " . Author::findById($photoBlockS3->author_id)->last_name ?></p>
                ...
                <div class="width-6 portrude longComponent ver2">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($photoBlockS4->author_id)->first_name . " " . Author::findById($photoBlockS4->author_id)->last_name ?></p>
                    ...
                    <div class="width-3 portrude cardComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($photoBlockS5->author_id)->first_name . " " . Author::findById($photoBlockS5->author_id)->last_name ?></p>
        ...
        <div class="container">
            ...
            <div class="width-9 combined">
                <div class="width-9 holder top">
                    ...
                    <div class="width-3 portrude mediumComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($techBlockS2->author_id)->first_name . " " . Author::findById($techBlockS2->author_id)->last_name ?></p>
                    ...
                    <div class="width-6 portrude longComponent ver1">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($techBlockS3->author_id)->first_name . " " . Author::findById($techBlockS3->author_id)->last_name ?></p>
                ...
                <div class="width-6 portrude longComponent ver2">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($techBlockS4->author_id)->first_name . " " . Author::findById($techBlockS4->author_id)->last_name ?></p>
                    ...
                    <div class="width-3 portrude cardComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($techBlockS1->author_id)->first_name . " " . Author::findById($techBlockS1->author_id)->last_name ?></p>
            ...
            <div class="width-3 portrude tallComponent ver1">
                ...
                <div class="whiteBox">
                    ...
                    <div class="category">
                        <p class="author"><?= Author::findById($techBlockS5->author_id)->first_name . " " . Author::findById($techBlockS5->author_id)->last_name ?></p>
        ...
        <div class="container">
            ...
            <div class="width-3 portrude tallComponent ver1">
                ...
                <div class="whiteBox">
                    ...
                    <div class="category">
                        <p class="author"><?= Author::findById($socialBlockS1->author_id)->first_name . " " . Author::findById($socialBlockS1->author_id)->last_name ?></p>
            ...
            <div class="width-9 combined">
                <div class="width-9 holder top">
                    ...
                    <div class="width-3 portrude mediumComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($socialBlockS2->author_id)->first_name . " " . Author::findById($socialBlockS2->author_id)->last_name ?></p>
                    ...
                    <div class="width-6 portrude longComponent ver1">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($socialBlockS3->author_id)->first_name . " " . Author::findById($socialBlockS3->author_id)->last_name ?></p>
                ...
                <div class="width-6 portrude longComponent ver2">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($socialBlockS4->author_id)->first_name . " " . Author::findById($socialBlockS4->author_id)->last_name ?></p>
                    ...
                    <div class="width-3 portrude cardComponent">
                        ...
                        <div class="whiteBox">
                            ...
                            <div class="category">
                                <p class="author"><?= Author::findById($socialBlockS5->author_id)->first_name . " " . Author::findById($socialBlockS5->author_id)->last_name ?></p>
